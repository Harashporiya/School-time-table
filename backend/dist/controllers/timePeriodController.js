...
export const getAllTimePeriods = async (req, res) => {
    try {
...
export const generateTimePeriods = async (req, res) => {
    try {
        const { totalPeriods, periodDuration, schoolStartTime, schoolEndTime, includeBreak, breakStartTime, breakEndTime, } = req.body;
        ...
        const createdPeriods = await prisma.$transaction(periods.map((period) => {
...
// Clear all periods
export const clearAllPeriods = async (req, res) => {
    try {
        await prisma.timePeriod.deleteMany({});
...
export const reorderTimePeriods = async (req, res) => {
    try {
...
export const bulkCreateTimePeriods = async (req, res) => {
    try {
        ...
        const createdPeriods = await prisma.$transaction(periods.map((period, index) => {
