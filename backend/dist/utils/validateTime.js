 ...
 */
export async function checkTeacherConflict(teacherId, day, startTime, // kept for compatibility
endTime, // kept for compatibility
timePeriodId, excludeTimetableId) {
